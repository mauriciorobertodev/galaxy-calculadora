...
<template>
    <!-- button -->
    <button type="button" class="flex items-center justify-center border border-primary-500 gap-2 text-primary-500 hover:bg-primary-600 hover:text-white h-12 px-6 rounded-full" v-on:click="open = true">
    ...
    <!-- modal -->
    <div v-if="open" class="bg-slate-900 fixed top-0 left-0 h-screen w-screen overflow-y-scroll py-6 z-50">
